...
public class EventsWatcher implements TestWatcher, BeforeTestExecutionCallback, BeforeAllCallback, BeforeEachCallback, AfterEachCallback, AfterAllCallback {
    ...
    @Override
    public void testDisabled(@NonNull final ExtensionContext context, @NonNull final Optional<String> reason) {
        notifyTest(context, AFTER, DISABLED, Set.of(TEST));
    }

    @Override
    public void testSuccessful(@NonNull final ExtensionContext context) {
        notifyTest(context, AFTER, SUCCESSFUL, Set.of(TEST));
    }

    @Override
    public void testAborted(@NonNull final ExtensionContext context, final Throwable throwable) {
        notifyTest(context, AFTER, ABORTED, Set.of(TEST));
    }

    @Override
    public void testFailed(@NonNull final ExtensionContext context, final Throwable exception) {
