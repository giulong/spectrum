...
class VideoDynamicInitConsumerTest {
    ...
    @InjectMocks
    private VideoDynamicInitConsumer videoDynamicInitConsumer;
    ...
    void getVideoPathFrom() {
        ...
        assertEquals(path, videoDynamicInitConsumer.getVideoPathFrom(testData));
    }
}
